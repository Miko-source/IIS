...
<div class="container">
    ...
    <h1>Vytvořit novou aktivitu</h1>

    @php
        $today = now()->format('Y-m-d');
        $startValue = old('start_date', $today);
    ...
    <form action="{{ route('activities.store', [$campaign->id, $step->id]) }}" method="POST">
        ...
        <button class="btn btn-primary">Vytvořit aktivitu</button>

    </form>

</div>

{{-- JS – kontrola datumu pri psani i kliknutí --}}
<script>
